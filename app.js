...
function TestStage(props) {
    ...
    function startInterval() {
        ...
        function intervalCallback() {
            ...
            if (instant.results.length > (loadTime > 1500 ? 10 : 10) /* || (transfer.time > 100 && instant.results.length > 3 && instant.results.length < 10)*/) {
    ...
    function requestConfig(req) {
        ...
        function progressUpload(e) {
            ...
            if (progressCount > 2) {
                ...
                req.buffer = {
                    size: buffer.size,
                    time: buffer.items[0].time,
                    averageTime: buffer.time / buffer.items.length
                };
            }
