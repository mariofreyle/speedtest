...
function StartButton(props) {
    ...
    this.handleClick = function () {
        ...
        setTimeout(function () {
            ...
            _App2.default.event("runTest", { runType: (0, _App.$)("#testSettings-startTestWith").value() });
        }, 1200);
    };
    this.onMount = function () {
