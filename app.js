...
function TestStage(props) {
    var $this = this,
        ...
        resultsGraph = (0, _App.createRef)("div"),
    ...
    function clearResults() {
        ...
        resultDownload.find("graph").addClass("unseen");

        resultUpload.find("resultValue").textContent("- -");
        resultUpload.find("graph").addClass("unseen");
    ...
    function drawGraph() {
        this.elem = (_TestConfig2.default.runType.download ? resultDownload : resultUpload).find("graph");
    ...
    function startInterval() {
        ...
        function intervalCallback() {
            ...
            instant.maxResults = loadTime > 1000 ? (12 || 12) : (3 || 3);
            instant.maxResults += Math.round(transfer.average.time / 80);
            instant.maxResults = instant.maxResults > 12 ? (12 || 10) : instant.maxResults;
            ...
            //runTime < 20000 && graph.draw(speedRateMbps(average.graph.get(average.speed, 15)), intervalTime);
            runTime < 20000 && graph.draw(speedRateMbps(average.graph.get(average.speed, 10)), intervalTime);
