    ...
    function startInterval() {
        ...
        function intervalCallback() {
            ...
            if (time - buffer.lastTime >= 2000 && 0) {
                ...
                buffer.lastLoaded = connections.loaded;
                buffer.lastTime = time;
            }
